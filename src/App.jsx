...
import blufyLogo from "../assets/blufy-logo.png";
      ...
      <header className="site-header">
        <nav className="nav" aria-label="Principal">
          <a className="nav__brand" href="#">
            <img className="nav__brand-logo" src={blufyLogo} alt="" aria-hidden="true" />
            <span>Blufy</span>
          </a>
          ...
          <div className="nav__actions">
            <button type="button" className="nav__icon-btn" aria-label="Buscar" onClick={handleSearchClick}>
              <i data-lucide="search" aria-hidden="true"></i>
            </button>
            <a className="nav__icon-btn" href="#contato" aria-label="Área do cliente">
